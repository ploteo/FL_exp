...
LANGUAGE_CODE = 'fr' # <- CHANGE GERE: it,en
...
# e.g. EUR, GBP, CNY, JPY
REAL_WORLD_CURRENCY_CODE = 'ML'# <- CHANGE GERE: it,en
USE_POINTS = True
POINTS_CUSTOM_NAME = 'Jetons'# <- CHANGE GERE: it,en
...
SESSION_CONFIGS = [
 ...
 dict(
    ...
    dict(
     ...
     treatment ="no_identity", #"identity" to have identity in the task of PGG
