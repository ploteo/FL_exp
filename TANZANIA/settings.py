...
# e.g. EUR, GBP, CNY, JPY
REAL_WORLD_CURRENCY_CODE = 'Pesa za Kenya'# CHANGE HERE
USE_POINTS = True
POINTS_CUSTOM_NAME = 'Tokeni'# CHANGE HERE
...
SESSION_CONFIGS = [
 ...
 dict(
    ...
    dict(
     ...
     treatment = treat_identity, #"identity" to have identity in the task of PGG or "no_identity" to have no identity (Water = it)
